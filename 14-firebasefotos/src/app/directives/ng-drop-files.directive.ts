...
export class NgDropFilesDirective {
  ...
  private _getTransfer(event: any){ // this function is used only to extend compatibility to different browser
  ...
  private _prevenirDetener(event){ // prevents default dropping behaviour 
